...
import 'package:food_recipes/screens/pages/homepages/list_view_four.dart';
import 'package:food_recipes/screens/pages/homepages/list_view_one.dart';
import 'package:food_recipes/screens/pages/homepages/list_view_three.dart';
              ...
              children: [
                ...
                Row(
                  children: const [
                    Text(
                      'See all',
                      style: TextStyle(fontSize: 14, color: Color(0xffE23E3E)),
                    ),
                    SizedBox(width: 2),
                    Icon(
